...
<div id="wrapper" class="col-12">
  ...
  <div id="content" class="col-12">
    <div id="contentL" class="col-6">
     <img src="../image/Animation/" alt="動漫名稱" title="動漫名" class="col-6">
    </div>
    
    <div id="contentR" class="col-6">
      動漫簡介:
      <div class="IntroContentR">　　簡介內容
      </div>
  	</div>
    <div class="Companyinfo" style="clear:left;">
      <li>動畫製作：<span> <a href="../Company/.php">公司</a></span></li> 
    </div>
    <div class="CVinfo" style="clear:left;">
      <li>聲優陣容：</li>
      
      <span>角色：<a href="../CV/.php">聲優</a></span>
