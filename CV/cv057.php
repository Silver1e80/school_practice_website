...
$query_CV = "Select cv.* From cv ";
$CV = mysql_query($query_CV, $cnAnime) or die(mysql_error());
$row_CV = mysql_fetch_assoc($CV);
$totalRows_CV = mysql_num_rows($CV);mysql_select_db($database_cnAnime, $cnAnime);
$query_CV = "SELECT cv.* FROM cv Where cvId = 'cv057'";
$CV = mysql_query($query_CV, $cnAnime) or die(mysql_error());
$row_CV = mysql_fetch_assoc($CV);
...
<div id="wrapper" class="col-12">
  ...
  <div id="content" class="col-12">
    <div id="contentL" class="col-6">
     <img src="../image/CV_photo/CVex.jpg" alt="<?php echo $row_CV['cvName']; ?>" title="<?php echo $row_CV['cvName']; ?>" class="col-6">
