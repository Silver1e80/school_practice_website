...
$query_Company_Studio = "Select company.* From company";
...
$totalRows_Company_Studio = mysql_num_rows($Company_Studio);mysql_select_db($database_cnAnime, $cnAnime);
$query_Company_Studio = "SELECT company.* FROM company";
$Company_Studio = mysql_query($query_Company_Studio, $cnAnime) or die(mysql_error());
$row_Company_Studio = mysql_fetch_assoc($Company_Studio);
...
<div id="wrapper" class="col-12">
  ...
  <div id="content" class="col-12">
    <div id="contentL" class="col-6">
     <img src="../image/Company_logo/<?php echo $row_Company_Studio['cName']; ?>" alt="<?php echo $row_Company_Studio['cName']; ?>" title="<?php echo $row_Company_Studio['cName']; ?>" class="col-6">
     <p><?php echo $row_Company_Studio['cName']; ?></p>
    </div>
    
    <div id="contentR" class="col-6">
      公司簡介:
      <div class="IntroContentR">　　<?php echo $row_Company_Studio['cDesc']; ?>
      </div>
  	</div>
  <footer class="col-12">
